            ...
            <div class="card-header">
                ...
                <nav class="navbar navbar-light bg-light ">
                    ...
                    <div class="text-right">
                        <a href="<?php echo e(route('categorias.create')); ?>"><button type="button" class="btn btn-primary">Crear nueva
                                categoria</button></a>
                    </div>
                </nav>
        ...
        <tbody>
            <?php if(count($categories)<=0): ?> <tr>
                ...
                <tr>
                    ...
                    <td><img src="<?php echo e(asset('img/categories/'.$category->img)); ?>"></td>
