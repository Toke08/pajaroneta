    ...
    <div class="row">
        <div class="col-md-8 offset-md-2">
            <div class="card">
                ...
                <div class="modal fade" id="user" tabindex="-1" role="dialog" aria-labelledby="changePasswordModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="<?php echo e(route('cambiar_contrasena')); ?>" method="post">
                                    ...
                                    <div class="form-group">
                                        <label for="confirm_password" id="cambiar">Confirmar Nueva Contraseña</label>
...
<?php echo $__env->make('layout.masterpage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\UniServerZ1\www\pajaroneta\resources\views/client/user_show.blade.php ENDPATH**/ ?>