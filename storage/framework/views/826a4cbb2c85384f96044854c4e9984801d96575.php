<div class="custom-shape-divider-bottom-1707587365">
...
<footer class=" text-center text-white text-align-center">
          ...
          <div class="row d-flex justify-content-center align-items-center">
            ...
            <div class="col-md-5 col-12">
              <div class="form-outline form-white ">
                <h4 class="pt-2">
                    <strong>lapajaronetatruck@gmail.com</strong>
                  </h4>
              </div>
            </div>
          </div>
    ...
    <div class="bg-custom pt-3 pb-3" style="background-color: #730000;">
        <ul class="list-unstyled padding row d-flex justify-content-center">
            ...
            <li class="footer-item mr-3" >
                <a class="footer-link" href="" style="color: white;">Política de cookies</a>
            </li>
        </ul>
    </div>
</footer>
...
<?php /**PATH C:\Users\Rod\Desktop\Desk\DAW\UniServerZ\www\pajaroneta\resources\views/layout/footer.blade.php ENDPATH**/ ?>